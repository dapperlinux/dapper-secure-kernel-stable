...
Name: dapper-secure-kernel%{?variant}
...
Patch26000: dapper-secure-kernel-patchset-4.9.130-2018-10-02.patch
...
%endif
    git init
    git config user.email "kernel-team@dapperlinux.com"
    git config user.name "Dapper Linux Kernel Team"
